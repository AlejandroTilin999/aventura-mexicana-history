...
export const Route = createFileRoute("/bloque2")({
  head: () => ({
    meta: [
      { title: "Bloque 2: La Conquista y el Virreinato | México Increíble" },
      {
        name: "description",
        content:
          "Descubre la caída de México-Tenochtitlan, la subordinación del Señorío Purépecha y el inicio del Virreinato, explicado para niñas y niños.",
      },
      { property: "og:title", content: "Bloque 2: La Conquista y el Virreinato" },
      {
        property: "og:description",
        content: "El encuentro de dos mundos explicado para niñas y niños de 8 años.",
      },
      { property: "og:type", content: "article" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
  }),
  component: Bloque2Page,
});

const tonos = ["bg-highlight", "bg-coral text-coral-foreground", "bg-era-turquoise"];

function Bloque2Page() {
  const [abierto, setAbierto] = useState<string | null>(bloque2.temas[0]?.id ?? null);
  ...
  return (
    <main className="bg-background text-foreground">
      ...
      {quizAbierto && (
        <Quiz
          preguntas={quizBloque2}
          tituloFinal="¡Felicidades, eres un experto en la Conquista!"
          siguiente={{ to: "/bloque3", label: "Pasar al siguiente bloque" }}
