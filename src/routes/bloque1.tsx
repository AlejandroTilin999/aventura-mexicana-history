...
export const Route = createFileRoute("/bloque1")({
  head: () => ({
    meta: [
      { title: "Bloque 1: El México Antiguo | México Increíble" },
      {
        name: "description",
        content:
          "Descubre las primeras comunidades, los códices de los tlacuilos y la fundación de México-Tenochtitlan en 12 historias para niñas y niños.",
      },
      { property: "og:title", content: "Bloque 1: El México Antiguo y los Pueblos Originarios" },
      {
        property: "og:description",
        content: "Doce historias del México antiguo explicadas para niñas y niños de 8 años.",
      },
      { property: "og:type", content: "article" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
  }),
  component: Bloque1Page,
});
  ...
  return (
    <main className="bg-background text-foreground">
      <header className="mx-auto flex max-w-[1100px] flex-col gap-6 px-5 py-10 md:px-10 md:py-16">
        ...
        <p className="text-sm font-extrabold uppercase text-primary">Bloque 1</p>
        <h1 className="max-w-4xl text-4xl font-extrabold leading-[0.98] md:text-6xl">
          El México Antiguo y los Pueblos Originarios
        </h1>
        <p className="max-w-2xl text-lg font-medium text-muted-foreground">{bloque1.intro}</p>
      </header>

      <section className="mx-auto flex max-w-[1100px] flex-col gap-6 px-5 pb-16 md:px-10">
        {bloque1.temas.map((tema, i) => {
